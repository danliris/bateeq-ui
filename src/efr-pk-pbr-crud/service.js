...
const serviceUri = 'http://bateeq-inventory-api.au-syd.mybluemix.net/v1/merchandisers/docs/efr-pk-pbr';  
const serviceUriDraft = 'http://bateeq-inventory-api.au-syd.mybluemix.net/v1/merchandisers/docs/efr-pk-pbr/draft'; 
