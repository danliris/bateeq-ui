...
export class Confirm {
  ...
  save(event) {
    ...
    //   if (this.data.DetailConfirms) {
    //     if (this.data.DetailConfirms.length > 0) {
    //       var warning = [];
    //       var warning_confirm = [];
    //       var total_item = 0;
    //       for (var item of this.data.DetailConfirms) {
    ...
    //           ? new Date(item._createdDate)
    //           : "";
    //         if (
    //           item._createdDate != "" &&
    //           item._createdDate.getFullYear() > 1900
    //         ) {
    ...
    //           break;
    //         } else if (
    //           new Date(item.deliveryDate) > new Date(this.data.deliveryDate)
    //         ) {
    //           warning = [];
    //           break;
    //         }
    ...
    //       if (total > 0)
    //         warning_confirm.push(
    //           "Total jumlah confirm lebih dari jumlah booking order\n"
    //         );

    //       if (warning.length > 0 && warning_confirm.length <= 0) {
    //         if (
    //           confirm(
    //             "Tanggal Confirm <= 45 hari \n" +
    //               warning.toString().replace(/,/g, "") +
    //               "Tetap Confirm?"
    //           )
    //         ) {
    //           this.service
