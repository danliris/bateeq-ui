...
export class App {
  ...
  configureRouter(config, router) {
    ...
    var routes = [ 
      ...
      { route: 'inventories',         name: 'inventories',        moduleId: './modules/storage-inventory/index',      nav: true, title: 'Inventories' ,                                                             settings: { group:"inventory", roles:["admin"] }},
      ...
      { route: 'efr-tb-bbt',          name: 'efr-tb-bbt',         moduleId: './modules/efr-tb-bbt-cr/index',          nav: true, title: 'Toko - Pemasukan Barang Jadi' ,                                            settings: { group:"store", roles:["admin"] }},
      { route: 'efr-tb-bat',          name: 'efr-tb-bat',         moduleId: './modules/efr-tb-bat-cr/index',          nav: true, title: 'Toko - Pemasukan Embalase' ,                                               settings: { group:"store", roles:["admin"] }},
      { route: 'efr-kb-rtp',          name: 'efr-kb-rtp',         moduleId: './modules/efr-kb-rtp-cr/index',          nav: true, title: 'Toko - Retur Barang Jadi (Baru)' ,                                         settings: { group:"store", roles:["admin"] }},
