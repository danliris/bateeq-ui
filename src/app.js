export class App {
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'Terima-Aksesoris',      name: 'Terima-Aksesoris',     moduleId: './transfer-in-cr/index', nav: true, title: 'Finishing Terima Aksesoris' },
      { route: 'Kirim-Aksesoris',      name: 'Kirim-Aksesoris',     moduleId: './transfer-out-cr/index', nav: true, title: 'Aksesoris Kirim Aksesoris' },
