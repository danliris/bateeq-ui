module.exports = [
    ...
    , {
        route: 'laporanTransferStok',
        name: 'laporanTransferStok',
        ...
        route: 'laporanDistribusiBarang',
        name: 'laporanDistribusiBarang',
    ...
    , {
        route: 'laporanStokRealisasiOrder',
        name: 'laporanStokRealisasiOrder',
