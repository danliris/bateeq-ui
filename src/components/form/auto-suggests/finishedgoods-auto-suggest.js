...
import FinishedgoodsAutoSuggestReact from '../../react/auto-suggests/finishedgoods-auto-suggest-react.jsx';
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <FinishedgoodsAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
