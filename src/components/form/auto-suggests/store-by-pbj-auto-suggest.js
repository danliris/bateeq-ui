...
import StoreByPbjAutoSuggestReact from '../../react/auto-suggests/store-by-pbj-auto-suggest-react.jsx';

@noView()
@inject(Element)
@customElement('store-by-pbj-auto-suggest')
    ...
    render() {
        ...
        this.reactComponent = ReactDOM.render(
            <FieldReact label={this.label} error={this.error}>
                <StoreByPbjAutoSuggestReact value={this.value} options={this.options} onChange={this.handleValueChange} />
            </FieldReact>,
            this.element
        );
    }
