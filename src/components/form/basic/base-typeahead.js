...
import AutoSuggestReact from './react/typeahead-react.jsx';
...
// import FieldReact from "./react/field-react.jsx";
// import Typeahead from "./react/typeahead-react.jsx";

// export default class BaseTypeahead {
//   @bindable({ defaultBindingMode: bindingMode.twoWay }) label;
//   @bindable({ defaultBindingMode: bindingMode.twoWay }) value;
//   @bindable({ defaultBindingMode: bindingMode.twoWay }) error;
//   @bindable({ defaultBindingMode: bindingMode.twoWay }) readOnly;
...
//     else this.options.filter = null;
//     var _options = Object.assign(
//       { readOnly: (this.readOnly || "").toString().toLowerCase() === "true" },
//       this.options
//     );
//     var AutoSuggestControl = this.control;
//     this.reactComponent = ReactDOM.render(
