...
export default class StoreByPbjAutoSuggestReact extends React.Component {
    constructor(props) {
        super(props);
    ...
    init(props) {
        var options = Object.assign({}, StoreByPbjAutoSuggestReact.defaultProps.options, props.options);
...
StoreByPbjAutoSuggestReact.propTypes = {
...
StoreByPbjAutoSuggestReact.defaultProps = {
    options: {
        readOnly: false,
        suggestions:
        function (text) {
