...
const serviceUri = require('../../../host').master + '/items/finished-goods';
const empty = {
    code: '',
    name: '',
    toString: function () {
...
export default class FinishedgoodsAutoSuggestReact extends React.Component {
    constructor(props) {
        super(props);
    ...
    options: {
        ...
        function (text) {
            ...
            return fetch(uri, { headers: requestHeader }).then(results => results.json()).then(json => {
                return json.data.map(finishedgoods => {
