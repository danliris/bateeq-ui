...
export async function configure(aurelia) {
  aurelia.use
    ...
    .plugin("aurelia-api", config => {
      ...
      var manufacture =
        "https://bateeq-core-api-dev.azurewebsites.net/v1/manufacture/";
      var inventory =
        "https://bateeq-inventory-api-dev.azurewebsites.net/v1/inventory/";
      var merchandiser =
        "https://bateeq-inventory-api-dev.azurewebsites.net/v1/merchandiser/";
      var md =
      ...
      var purchasing =
        "https://bateeq-inventory-api-dev.azurewebsites.net/v1/purchasing/";
      var masterplan =
