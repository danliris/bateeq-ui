...
export async function configure(aurelia) {
  aurelia.use
    ...
    .plugin("aurelia-api", config => {
      ...
      var manufacture =
        "https://bateeq-core-api.azurewebsites.net/v1/manufacture/";
      var inventory =
        "https://bateeq-inventory-api.azurewebsites.net/v1/inventory/";
      var merchandiser =
        "https://bateeq-inventory-api.azurewebsites.net/v1/merchandiser/";
      var md =
        "https://com-bateeq-service-merchandiser-uat.azurewebsites.net/v1/";
      var sales = "https://bateeq-pos-api.azurewebsites.net/v1/sales/";
      var purchasing =
        "https://bateeq-inventory-api.azurewebsites.net/v1/purchasing/";
      var masterplan =
